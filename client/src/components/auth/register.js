...
import {connect} from 'react-redux';//if we use connect we have to modify the export part
...
const Register = ({setAlert,register,isAuthenticated}) => {
    ...
    const {name,email,password,password2} =formData;//fetching from form data
